  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-rose-50 to-pink-100 flex items-center justify-center p-4">
      ...
      <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-6 max-w-sm w-full border border-pink-100">
        ...
        {/* Top Toggle Button (de-emphasized link style) */}
        <div className="mb-4 text-center">
          <button
            onClick={toggleAuthMode}
            className="mx-auto text-gray-600 hover:text-pink-600 font-medium text-sm underline underline-offset-4 transition-colors duration-200"
          >
            {isSignUp ? 'Switch to Login · Ku soo gal' : 'Switch to Create Account · Account sameeso'}
          </button>
        </div>
        ...
        {/* Bottom Toggle Removed as requested */}
      </div>
    </div>
  )
}